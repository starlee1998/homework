...
**说明**：这张图展示的是单元格B14的计算过程，其他单元格与此类似。其中，2016年计算出的增速（20%左右）与统计局公布的增速（7%左右）相差较大，而且看起来也不太靠谱。我检查了几遍不知道哪里出了问题，于是用**现价GDP**数据又计算了一下2015年和2016年的各季度GDP增速，如图。

![尝试用现价GDP计算](https://github.com/starlee1998/homework/blob/master/%E5%B0%9D%E8%AF%95%E7%94%A8%E7%8E%B0%E4%BB%B7GDP%E8%AE%A1%E7%AE%97%E5%A2%9E%E9%80%9F.png)


计算完之后发现2016年各季度增速数值合理，但是依然跟统计局公布的对不上……并且这样一算2015年的各季度增速也对不上了，说明问题并不是出在现价和不变价GDP的选取上。

**那为什么之前用不变价GDP计算出的2016年各季度增速如此之大？**

我感觉是网站公布的统计数据的问题（虽然觉得高大上的国家统计局应该不会犯这种错误……但是那些数据看起来确实无法算出7%的增速），我给统计局打电话咨询，工作人员让我在网站提交统计咨询，我已经提交了，正在等待工作人员的回复。
