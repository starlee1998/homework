...
我总是在想办法用数据得出结论，并且非常注重现象之间的“推导”，这好像是做研究的思维。我发现目前学者们对于数据新闻的认知分成两派，一派是认为数据新闻应该讲故事，一派认为数据新闻从属于社会科学研究（曾庆香），似乎是这两派，以前看的资料我也记不太清了。我对于什么样的数据新闻是好的数据新闻其实不是很清楚，不知道老师是如何看待这个问题的？
